...
<div class="content-header-fixed px-1">
    <div class="content__header--inner">
        <x-search-filter :keywords="request('keywords')" :filters="['Mã', 'Tên', 'Chức vụ', 'Địa chỉ', 'Điện thoại', 'Email']">
            ...
            <x-filter-checkbox :dataa='$roles' button="chuc-vu" name="chuc-vu" title="Chức vụ" button="chuc-vu"
                namedisplay="name" />
        </x-search-filter>
        ...
        <div class="d-flex content__heading--right">
            <div class="row m-0">
                <a href="{{ route('users.create') }}" class="activity mr-3" data-name1="KH" data-des="Tạo mới">
...
<div class="content margin-top-75">
    <section class="content">
        <div class="container-fluided">
            <div class="row result-filter-user margin-left20 my-1 mr-0">
            </div>
                    ...
                    <div class="outer2 table-responsive text-nowrap">
                        <table id="example2" class="table table-hover bg-white rounded">
                            ...
                            <tbody class="tbody-user">
                                <tr class="height-40">
                                    <td class="text-purble border-bottom py-1 border-top-0 border-right pl-4"
                                        style="font-size: 16px;" colspan="10" class="border-bottom">Nhóm nhân viên:
                                        Chưa chọn nhóm
                                    </td>
                                </tr>
                                @php
...
<script type="text/javascript">
    $(document).on('click', '.btn-submit', function(e) {
        ...
        var formData = {
            ...
            roles: getStatusData(this, 'chuc-vu'),
        ...
        // Gọi hàm AJAX
        var route = "{{ route('filter-users') }}"; // Thay route phù hợp
        var nametable = 'user'; // Thay tên bảng phù hợp
