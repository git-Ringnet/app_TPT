                        ...
                        <table id="example2" class="table table-hover">
                            ...
                            <tbody class="tbody-provide">
                                ...
                                @foreach ($groups as $value)
                                    ...
                                    @endphp
                                    <tr class="height-40">
                                        <td class="text-purble border-bottom py-1 border-right border-top-0 pl-4"
                                    ...
                                    @endforeach
                                    <tr class="height-40">
                                        <td class="border-right-0 border-bottom py-0 border-top-0"></td>
                                        <td
                                            class="text-right border-left border-right-0 border-bottom py-0 border-top-0 text-purble">
                                            Có <strong>{{ $total }}</strong> nhà cung cấp
                                        </td>
                                        <td class="border-bottom border-left py-0 border-top-0" colspan="13">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
