...
<div class="content-header-fixed px-1">
    <div class="content__header--inner">
        ...
        <div class="d-flex content__heading--right">
            ...
            <div class="row m-0">
                <a href="{{ route('customers.create') }}" class="activity mr-3" data-name1="KH" data-des="Tạo mới">
                    ...
                    <div class="outer2 table-responsive text-nowrap">
                        <table id="example2" class="table table-hover bg-white rounded">
                            <thead class="border-custom">
                                <tr>
                                    <th class="height-40 py-0 border border-right-0" scope="col" style="width: 10%;">
                                    ...
                                    <th class="height-40 py-0 border border-right-0" scope="col" style="width: 20%;">
                                        <span class="d-flex justify-content-start">
                                    ...
                                    <th class="height-40 py-0 border border-right-0" scope="col" style="width: 15%;">
                                        <span class="d-flex justify-content-start">
                            ...
                            <tbody class="tbody-guest">
                                <tr class="height-40">
                                    <td class="text-purble border-bottom py-1 border-right pl-4 border-top-0"
                                        style="font-size: 16px;" colspan="6">Khách hàng : Chưa chọn nhóm</td>
                                </tr>
                                ...
                                <tr class="height-40">
                                    ...
                                    <td class="text-right py-0 border-top-0 border-left border-right-0 border-bottom text-13-black text-purble"
                                        data-id="0">Có
                                        <strong class="total_guest" data-id="0">
                                            {{ $count }}
                                        </strong> khách hàng
                                    </td>
                                    <td class="border-top-0 border-bottom border-left" colspan="5"></td>
                                </tr>
...
<script type="text/javascript">
    $(document).on('click', '.btn-submit', function(e) {
        ...
        // Gọi hàm AJAX
        var route = "{{ route('filter-customer') }}"; // Thay route phù hợp
        var nametable = 'guest'; // Thay tên bảng phù hợp
